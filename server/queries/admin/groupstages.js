module.exports = {
  ...
  "getWeekSequence" :  "select distinct(f.matchweek) as weekSequence from VIEW_ADMIN_FIXTURES f join VIEW_ADMIN_GROUPSTAGES g on g.id = f.groupstageid where f.groupstageid = ? order by weekSequence" ,
