module.exports = {
  ...
  "createTeamsInGroupstagesBeforeInsert" : "delete from teamsingroupstages where groupstageId = ?" ,
  ...
  "deleteTeamsInGroupstages" : "delete from teamsingroupstages where groupstageId = ?"
}
